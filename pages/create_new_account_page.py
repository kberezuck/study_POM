...
class CreateNewAccountPage(BasePage):
    ...
    def check_validation_messages(self):
        ...
        for element in error_elements:
            ...
            print(element.text)
            self.wait.until(EC.text_to_be_present_in_element(self.error_for_requirement_field, 'This is a required field.'))

    def check_success_alert_is_visible(self):
        self.wait.until(EC.text_to_be_present_in_element(self.allert, 'Thank you for registering with Main Website Store.'))
